...
#defining RF algorithm with optimum hyperparameters which has been obtained from tuning part
rf = RandomForestRegressor(bootstrap= True, max_depth= 6, max_features = 'auto', min_samples_leaf= 2, min_samples_split= 3, n_estimators =50)
