...
#Creating list of alpha for Ridge regression tuning
...
#Create instance of Ridge algorithm with tuning and fit them using data of training part
ridge = Ridge()
...
Y_Pred_Train = ridge_search.predict(X_Train)
Y_Pred_Test = ridge_search.predict(X_Test)
